...
function Character({ character }) {
  return (
    <div className="grid grid-cols-[4rem,1fr,2rem,2rem] grid-rows-2 gap-x-4 bg-slate800 rounded-lg p-3 cursor-pointer transition-all duration-[0.2s] ease-out hover:bg-slate700 mb-6 last:mb-0">
      <img
        src={character.image}
        alt=""
      ...
      <button className="col-start-5 col-end-5 row-start-1 row-end-3 self-center  col-span-2  text-rose500  ">
